document.addEventListener('DOMContentLoaded', async function() {
    ...
    function isAuthenticated() {
        ...
        // Sessão expira após 2 horas (7200000 ms)
        const sessionDuration = 7200000;
        
        // Se autenticado e a sessão não expirou
        return authenticated && (currentTime - authTime < sessionDuration);
    }
    
    // Implementação da função MD5 para verificação de senha
    function md5(string) {
